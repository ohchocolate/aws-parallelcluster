...
from pcluster.api.models.detail import Detail  # noqa: E501
...
class DescribeClusterResponseContent(Model):
    ...
    def __init__(self, cluster_name=None, region=None, version=None, cloud_formation_stack_status=None,
                 cluster_status=None, scheduler=None, cloudformation_stack_arn=None, creation_time=None,
                 last_updated_time=None, cluster_configuration=None, compute_fleet_status=None, tags=None,
                 head_node=None, failures=None, details=None):  # noqa: E501
    ...
    def cluster_name(self, cluster_name):
        ...
        if cluster_name is not None and not re.search(r'^[a-zA-Z][a-zA-Z0-9-]+$', cluster_name):  # noqa: E501
            raise ValueError(
                "Invalid value for `cluster_name`, must be a follow pattern or equal to `/^[a-zA-Z][a-zA-Z0-9-]+$/`")  # noqa: E501
